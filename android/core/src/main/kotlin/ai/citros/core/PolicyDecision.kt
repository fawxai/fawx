...
object PolicyReasonCode {
    ...
    const val DENY_POLICY_EVAL_EXCEPTION = "deny.policy_eval_exception"
    const val DENY_EGRESS_UNAPPROVED = "deny.egress.unapproved"
    const val DENY_EGRESS_MISSING_URL = "deny.egress.missing_url"
    const val DENY_EGRESS_MALFORMED_URL = "deny.egress.malformed_url"
    const val DENY_EGRESS_INSECURE_SCHEME = "deny.egress.insecure_scheme"
