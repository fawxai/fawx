...
//!
//! ```rust,no_run
//! use ct_security::audit::{AuditLog, AuditEvent, AuditEventType, AuditFilter};
//! use std::path::Path;
//!
//! #[tokio::main]
...
//!
//! ```rust,no_run
//! use ct_security::audit::{AuditLog, AuditEvent, AuditEventType};
//! use std::path::Path;
//! use std::sync::Arc;
//! use tokio::sync::Mutex;
//!
//! #[tokio::main]
//! async fn main() -> Result<(), ct_core::error::SecurityError> {
...
//!         Ok::<(), ct_core::error::SecurityError>(())
//!     });
//!
//!     handle.await.unwrap()?;
//!     Ok(())
