...
impl LoopEngine {
    ...
    fn request_build_context(&self) -> RequestBuildContext<'_> {
        ...
        .with_skill_prompt_summaries(self.runtime_skill_prompt_summaries())
    }

    fn runtime_skill_prompt_summaries(&self) -> Vec<SkillPromptSummary> {
