...
fn evaluation_build_success(evaluation: &fx_consensus::Evaluation) -> bool {
    note_flag(&evaluation.notes, "build_ok").unwrap_or_else(|| {
        evaluation
            .fitness_scores
            .get("build_success")
            .copied()
...
#[cfg(test)]
mod tests {
    use super::{note_denominator, note_flag, note_number, note_value};
