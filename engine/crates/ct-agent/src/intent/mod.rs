...
//! # Overview
//!
//! This module provides intent classification for the Citros agent. It uses Claude
...
//!
//! ```no_run
//! use ct_agent::intent::{IntentClassifier, ClassifierConfig, LlmClassifier};
//! use ct_agent::{ClaudeClient, ClaudeConfig};
//! use ct_core::types::{UserInput, InputSource};
//!
