...
//!
//! Migration note: `ct-agent/src/claude/types.rs` currently defines Claude-specific
//! equivalents. This module is the new cross-provider target, and ct-agent can
