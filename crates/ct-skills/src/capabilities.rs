...
use ct_core::error::SkillError;
use std::collections::HashSet;

#[cfg(feature = "audit")]
use {
    ct_security::{AuditEvent, AuditEventType, AuditLog},
...
impl CapabilityChecker {
    ...
    /// # Example
    /// ```no_run
    /// # use ct_skills::CapabilityChecker;
    /// # use ct_skills::manifest::Capability;
    /// # #[cfg(feature = "audit")]
    /// # use ct_security::AuditLog;
    /// # async fn example() {
    /// # #[cfg(feature = "audit")]
