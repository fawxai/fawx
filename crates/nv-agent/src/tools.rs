//! Tool definitions for Nova phone actions.

use crate::claude::types::Tool;
use serde_json::json;

/// Get all Nova action tools for Claude.
pub fn nova_action_tools() -> Vec<Tool> {
    vec![
        tap_tool(),
        swipe_tool(),
        type_text_tool(),
...
mod tests {
    ...
    #[test]
    fn test_nova_action_tools_count() {
        let tools = nova_action_tools();
