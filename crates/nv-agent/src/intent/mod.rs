...
//! # Overview
//!
//! This module provides intent classification for the Nova agent. It uses Claude
...
//!
//! ```no_run
//! use nv_agent::intent::{IntentClassifier, ClassifierConfig, LlmClassifier};
//! use nv_agent::{ClaudeClient, ClaudeConfig};
//! use nv_core::types::{UserInput, InputSource};
//!
