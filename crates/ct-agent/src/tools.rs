//! Tool definitions for Citros phone actions.

use crate::claude::types::Tool;
use serde_json::json;

/// Get all Citros action tools for Claude.
pub fn citros_action_tools() -> Vec<Tool> {
    vec![
        tap_tool(),
        swipe_tool(),
        type_text_tool(),
...
mod tests {
    ...
    #[test]
    fn test_citros_action_tools_count() {
        let tools = citros_action_tools();
