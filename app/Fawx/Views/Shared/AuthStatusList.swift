        ...
        VStack(alignment: .leading, spacing: FawxSpacing.paddingMD) {
            ...
            if displayedAuthProviders.isEmpty {
                VStack(alignment: .leading, spacing: FawxSpacing.paddingSM) {
                    Text("No model provider credentials configured yet.")
                        .font(FawxTypography.chatBody)
                        .foregroundStyle(Color.fawxText)

                    Text("Add Claude, ChatGPT, OpenRouter, or Fireworks credentials here. GitHub credentials are managed from Skills > GitHub > Settings.")
                        .font(FawxTypography.chatBody)
